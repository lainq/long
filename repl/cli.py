...
def prompt(prompt_message=">"):
    ...
    try:
        ...
        exception = LongReplException("Your keyboard interrupted", "Restart the repl", "KeyBoardInterrupt")
        process.exit()
...
def execute_code_snippet(code_snippet):
    ...
    try:
        ...
        error = LongReplException("An unknown error occured", "Try again", "UnknownError")
        process.exit()
